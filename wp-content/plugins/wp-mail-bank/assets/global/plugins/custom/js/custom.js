!function ($) {
   ...
   $.fn.tooltip_tip = function (option) {
      return this.each(function () {
         var $this = $(this), data = $this.data('tooltip_tip'), options = typeof option == 'object' && option
         if (!data)
   ...
   $.fn.tooltip_tip.defaults = {animation: !0, placement: 'top', selector: !1, template: '<div class="tooltip_tip"><div class="tooltip_tip-arrow"></div><div class="tooltip_tip-inner"></div></div>', trigger: 'hover', title: '', delay: 0, html: !1}
